        ...
        <ScrollView style = {{ "backgroundColor": colours.main_background }}>
            {previousWorkoutsList.length === 0 ? (
                ...
                previousWorkoutsList.map((previousWorkout) => { return (
                    <TouchableOpacity key = {previousWorkout.id} style = {{ "backgroundColor": colours.button_background_1 }} className = "p-2 h-20 justify-center mt-[5px] w-4/6 items-center self-center mb-5">
